                ...
                <div class="box box-primary">
                    <div class="box-body">
                       ...
                       <div class="form-group">
                            ...
                            <asp:RegularExpressionValidator ID="evNIT" runat="server" ErrorMessage="El numero de documento solo debe contener 10 dígitos y deben ser números" ControlToValidate="txtNroDocumento" ForeColor="#FF3300" ValidationExpression="[0-9]{10}" ValidationGroup="DatosRequeridos"></asp:RegularExpressionValidator>
                       </div>
