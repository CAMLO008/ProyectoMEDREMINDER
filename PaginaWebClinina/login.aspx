    ...
    <form id="form1" runat="server">
        <div class="form-box" id="login-box">
            <asp:Login ID="LoginUser" runat="server" EnableViewState="false" OnAuthenticate="LoginUser_Authenticate" Width="100%" Height="600px">
                <LayoutTemplate>
                    <div class="header bg-purple">Bienvenido</div>
                    ...
                    <div class="footer">
                        <asp:Button ID="btnIngresar" CommandName="Login" runat="server" Text="Iniciar Sesión" CssClass="btn bg-purple btn-block" />
                    </div>
                </LayoutTemplate>
            </asp:Login>
        </div>
